...
export const buttonClassName =
  "inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#f05c40] px-5 py-3 text-sm font-bold text-white shadow-[0_4px_14px_rgba(240,92,64,0.3)] transition hover:bg-[#d94e34] disabled:cursor-not-allowed disabled:opacity-60";

export const fieldErrorClassName = "mt-1 text-xs font-medium text-red-600";
